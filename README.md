...
Holt's Linear Exponential Smoothing — a time-series model that captures both level and trend. Parameters (α=0.10, β=0.05) were selected by grid-search RMSE minimisation on the historical series (in-sample RMSE: ~71,000, or <1.2% of population).

Demographic Component Model — extrapolates population using the standard identity:
...
Age-Structure Cross-Check — the Census age-by-year file (2020–2025) was used to validate cohort composition and confirm the declining natural increase assumption.
